...
#ifdef T_Display_S3_Pro_MVSRBoard
    pinMode(MAX98357A_SD_MODE, OPEN_DRAIN);
#endif

#if defined(T_Display_S3_Pro_MVSRBoard_202409241139) || defined(T_Display_S3_Pro_MVSRBoard_202411011729)
